...
const DEFAULT_DESCRIPTION = 'Next.js frontend and admin panel for ecommerce platform';
...
const stripHtml = (value) => normalizeText(String(value || '').replace(/<[^>]*>/g, ' ')).replace(/\s+/g, ' ');
