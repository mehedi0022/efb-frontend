    ...
    <div className="min-h-screen flex w-full">
        ...
        <div className="z-10 text-center px-10">
          <div className="text-white space-y-2">
            <h2 className="text-3xl font-bold">
              Your All-in-One Ecommerce & Dropshipping Solution
            </h2>
            <p className="text-lg mt-3 text-white/80">
              Manage orders, track shipments, and scale your dropshipping
      ...
      <div className="w-full lg:w-1/2 bg-[#f8f8f8] flex flex-col lg:items-center lg:justify-center">
        <div
          ...
          style={{
            backgroundColor: "rgb(47 128 192 / var(--tw-bg-opacity, 1))",
          }}
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-sm text-[#2f80c0] font-semibold hover:underline"
                >
                  Forgot Password?
                </a>
              </div>
