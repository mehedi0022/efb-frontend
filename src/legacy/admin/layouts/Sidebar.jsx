...
const menuItems = [
    ...
    },
    {
        ...
        prefixes: ['/orders'],
        children: [
            { title: 'Create Order', path: '/orders/create', permission: 'orders.edit' },
            { title: 'All Order', path: '/orders/all', permission: 'orders.view' },
            { title: 'Pending', path: '/orders/pending', permission: 'orders.view' },
            { title: 'Processing', path: '/orders/processing', permission: 'orders.view' },
            { title: 'Confirmed', path: '/orders/confirmed', permission: 'orders.view' },
            { title: 'Delivered', path: '/orders/delivered', permission: 'orders.view' },
            { title: 'Complete', path: '/orders/complete', permission: 'orders.view' },
            { title: 'Cancelled', path: '/orders/cancelled', permission: 'orders.view' },
            { title: 'Returned', path: '/orders/returned', permission: 'orders.view' },
    ...
    },
    {
        ...
        icon: FiDatabase,
        key: 'products',
        prefixes: ['/products', '/categories', '/subcategories', '/brands', '/colors', '/sizes'],
        children: [
            { title: 'Product Manage', path: '/products', permission: 'products.view' },
            { title: 'Categories', path: '/categories', permission: 'categories.view' },
            { title: 'Subcategories', path: '/subcategories', permission: 'subcategories.view' },
    ...
    },
    {
        ...
        children: [
            ...
            { title: 'Pending Reviews', path: '/reviews/pending', permission: 'reviews.view' },
        ],
    },
    {
        title: 'Incomplete',
    ...
    },
    {
        ...
        children: [
            ...
            { title: 'Permissions', path: '/permissions', permission: 'permissions.view' },
        ],
    },
    {
        title: 'Site Setting',
        ...
        prefixes: ['/settings'],
        children: [
            { title: 'General Setting', path: '/settings', permission: 'settings.view' },
            { title: 'Contact', path: '/settings/contacts', permission: 'settings.view' },
            { title: 'Shipping Charge', path: '/settings/shipping-charges', permission: 'settings.view' },
            { title: 'Order Status', path: '/settings/order-statuses', permission: 'settings.view' },
        ],
    },
    {
        title: 'Configuration',
        ...
        children: [
            { title: 'Useful & References', path: '/footer-config/links', permission: 'settings.view' },
            { title: 'Social Media Links', path: '/footer-config/social-links', permission: 'settings.view' },
        ],
    },
    {
        ...
        children: [
            { title: 'Payment Gateway', path: '/integrations/payment', permission: 'integrations.view' },
            { title: 'SMS Gateway', path: '/integrations/sms', permission: 'integrations.view' },
            { title: 'Courier API', path: '/integrations/courier', permission: 'integrations.view' },
        ],
    },
    {
        title: 'Pixel and GTM',
        ...
        children: [
            ...
            { title: 'GTM Setting', path: '/tag-managers', permission: 'tag-managers.view' },
        ],
    },
    {
        title: 'Banner & Ads',
        icon: FiImage,
        key: 'banner',
        prefixes: ['/banner-categories', '/banners'],
        children: [
            { title: 'Banner Categories', path: '/banner-categories', permission: 'banner-categories.view' },
    ...
    },
    {
        ...
        prefixes: ['/reports'],
        children: [
            { title: 'Order Reports', path: '/reports/orders', permission: 'reports.view' },
        ],
    },
];
        ...
        <div className={clsx(
            ...
            <div className="flex h-full min-h-0 flex-col" data-simplebar>
                ...
                <div className="h-16 flex items-center justify-center border-b border-gray-700 bg-admin-dark sticky top-0 z-10">
                    <Link to={hasPermission('dashboard.view', authUser) ? '/dashboard' : '/'} onClick={onNavigate} className="flex items-center gap-2 px-4">
                ...
                <div className="p-4 border-b border-gray-700 bg-white/5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-white font-semibold text-sm m-0">{displayName}</p>
                ...
                {/* Sidebar Menu */}
                <div id="sidebar-menu" className="min-h-0 flex-1 overflow-y-auto py-3 pb-24">
                                                            ...
                                                            >
                                                                <span className="flex items-center gap-3">
                                                                    <FiCircle
                                                                        className={clsx(
                                                                            'h-2 w-2',
                                                                            isActive(child.path) ? 'fill-white' : 'fill-gray-400'
                                                                        )}
                                                                    />
                                                                    {child.title}
                                                                </span>
                                        ...
                                        >
                                            <item.icon
                                                className={clsx(
                                                    ...
                                                    isActive(item.path)
                                                        ? 'text-white'
                                                        : (item.iconClass ? `${item.iconClass} group-hover:text-emerald-300` : 'text-gray-400 group-hover:text-white')
                                                )}
                                            />
                                            <span className="flex items-center gap-2 text-sm font-medium">
                                                {item.title}
