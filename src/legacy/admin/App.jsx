...
import { getDefaultAdminRoute, getStoredAdminUser, hasPermission } from './utils/rbac';
...
const AccessDenied = ({ permission }) => (
    <div className="rounded-xl border border-red-100 bg-red-50 p-8 text-center">
        ...
        {permission && (
            <p className="mt-2 text-xs text-red-500">Required permission: {permission}</p>
        )}
    </div>
);
        ...
        <Router {...routerProps}>
            ...
            <Routes>
                ...
                <Route path="/" element={<RequireAdminAuth><AdminLayout /></RequireAdminAuth>}>
                    ...
                    <Route path="products/create" element={<RequirePermission permission="products.create"><ProductCreate /></RequirePermission>} />
                    <Route path="products/edit/:id" element={<RequirePermission permission="products.edit"><ProductEdit /></RequirePermission>} />
                    <Route path="products/:id" element={<RequirePermission permission="products.view"><ProductView /></RequirePermission>} />
                    <Route path="categories" element={<RequirePermission permission="categories.view"><CategoryList /></RequirePermission>} />
                    <Route path="subcategories" element={<RequirePermission permission="subcategories.view"><SubcategoryList /></RequirePermission>} />
                    <Route path="brands" element={<RequirePermission permission="brands.view"><BrandList /></RequirePermission>} />
                    <Route path="colors" element={<RequirePermission permission="colors.view"><ColorList /></RequirePermission>} />
                    <Route path="sizes" element={<RequirePermission permission="sizes.view"><SizeList /></RequirePermission>} />

                    {/* Reviews */}
                    <Route path="reviews" element={<RequirePermission permission="reviews.view"><ReviewList /></RequirePermission>} />
                    <Route path="reviews/:filter" element={<RequirePermission permission="reviews.view"><ReviewList /></RequirePermission>} />

                    {/* Settings */}
                    <Route path="profile" element={<ProfileView />} />
                    <Route path="account-settings" element={<AccountSettings />} />
                    <Route path="settings" element={<RequirePermission permission="settings.view"><GeneralSettings /></RequirePermission>} />
                    <Route path="settings/contacts" element={<RequirePermission permission="settings.view"><ContactSettings /></RequirePermission>} />
                    <Route path="settings/pages" element={<Navigate to="/footer-config/links" replace />} />
                    <Route path="settings/shipping-charges" element={<RequirePermission permission="settings.view"><ShippingChargeSettings /></RequirePermission>} />
                    <Route path="settings/order-statuses" element={<RequirePermission permission="settings.view"><OrderStatusSettings /></RequirePermission>} />
                    <Route path="footer-config/links" element={<RequirePermission permission="settings.view"><CreatePageSettings /></RequirePermission>} />
                    <Route path="footer-config/social-links" element={<RequirePermission permission="settings.view"><FooterSocialLinks /></RequirePermission>} />
                    <Route path="ip-blocks" element={<RequirePermission permission="ip-blocking.view"><IpBlockSettings /></RequirePermission>} />
                    <Route path="settings/ip-blocks" element={<Navigate to="/ip-blocks" replace />} />

                    {/* API Integrations */}
                    <Route path="integrations/payment" element={<RequirePermission permission="integrations.view"><PaymentGatewaySettings /></RequirePermission>} />
                    <Route path="integrations/sms" element={<RequirePermission permission="integrations.view"><SmsGatewaySettings /></RequirePermission>} />
                    <Route path="integrations/courier" element={<RequirePermission permission="integrations.view"><CourierApiSettings /></RequirePermission>} />
                    ...
                    {/* Incomplete Orders */}
                    <Route path="incomplete-orders" element={<RequirePermission permission="incomplete-orders.view"><IncompleteOrderList /></RequirePermission>} />

                    {/* Reports */}
                    <Route path="reports/orders" element={<RequirePermission permission="reports.view"><OrderReport /></RequirePermission>} />

                    {/* Employee RBAC modules */}
                    <Route path="users" element={<RequirePermission permission="users.view"><UserList /></RequirePermission>} />
                    <Route path="roles" element={<RequirePermission permission="roles.view"><RoleList /></RequirePermission>} />
                    <Route path="permissions" element={<RequirePermission permission="permissions.view"><PermissionList /></RequirePermission>} />

                </Route>

                {/* Redirect root to admin dashboard */}
                <Route path="/" element={<Navigate to={getDefaultAdminRoute()} replace />} />
